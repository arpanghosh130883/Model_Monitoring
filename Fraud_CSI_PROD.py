...
# Note:  Create a table as per the attached shared train data csv and read data from that table as train data

prod_data = pd.read_csv('testdataSIT_new.csv', error_bad_lines=False, index_col=0)
#  Note: Read only the 43 independent features from Payload_response table in Production 
